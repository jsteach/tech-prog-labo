...
/*
* Declarer une structure de donnee appeler Queue qui est un noeud comme le Node de la liste doublement chainee.
  Declare aussi un noeud qui va avoir le nom Node.
*/
...
/*
* Enlever l'element de la queue/file et retourner le noeud. 
  Si jamais il n'y a pas de noeud, retourner NULL.
*/
Node* pop(Queue* q);
